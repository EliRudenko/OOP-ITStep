let year; // массив строковых значений
...
let list = [1, 2, 3]; // определение числового массива и его инициализация
for (let i = 0; i < list.length; i++) {
    console.log(list[i]);
}
let values = [-1, -2, -3]; // создание массива используя generic тип данных Array
