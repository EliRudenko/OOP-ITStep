...
Создать класс BankAccount, который будет моделировать банковский счет. У каждого клиента будет свой баланс. Также будет одно статическое поле для хранения общего количества созданных счетов.
